...
function Header() {
  ...
  const totalItems = Object.values(basket).reduce((total, item) => total + item.quantity, 0);
        ...
        <Navbar expand="lg" className="navbar">
          ...
          <div className="header-container">
            <Form inline="true" className="search-form">
              ...
              />
              <Button className="custom-button" onClick={handleSearchButtonClick}>Search</Button>
            </Form>
          </div>
        ...
        <Modal.Body>
          <ul className="search-results">
            {filteredProducts.map(product => (
              <li key={product.productId} onClick={() => handleProductClick(product.productId)} className="search-result-item">
                {product.title}
              </li>
            ))}
          </ul>
